...
class ComentariosControllerTest < ActionController::TestCase
  ...
  test "should create comentario" do
    assert_difference('Comentario.count') do
      post :create, comentario: { email: @comentario.email, mensaje: @comentario.mensaje, nombre: @comentario.nombre, telefono: @comentario.telefono }
    end
  ...
  test "should update comentario" do
    patch :update, id: @comentario, comentario: { email: @comentario.email, mensaje: @comentario.mensaje, nombre: @comentario.nombre, telefono: @comentario.telefono }
    assert_redirected_to comentario_path(assigns(:comentario))
  end
